...
export const Navbar = ()=>{
        ...
        return(
            <nav className=" flex sticky top-0 w-screen z-2 gap-20 p-10 bg-transparent h-15 pt-2 ml-0 shadow-2xl   ">
                <h1 className="brandsm text-lg lg:text-4xl font-extrabold p-2 lg:pl-15">UrbanFit</h1>
                ...
                <div onClick={()=>setIsCartOpened(true)} className="absolute right-2 lg:right-15 ">
