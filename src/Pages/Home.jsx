...
export const Home=()=>{
    return(
        ...
        <Navbar/>
        <div className="h-200  ">
            <h1 className="text-[450px] text-amber-50 font-semibold absolute top-90 left-3">UrbanFit</h1>
            <p className="text-5xl font-extralight  text-amber-50 absolute top-125 left-10">Unleash the Drip.</p>
            {/* <img className="absolute left-130 top-10" src="/adobe.png" width={718} alt="" /> */}
            <video className=" absolute -z-10 top-30" src="/video.mp4" autoPlay loop muted playsInline></video>
        </div>
        ...
        <div className="h-[1024px] flex gap-50 ">
            <div>
