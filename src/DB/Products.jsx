const MenProducts = [
    {
        id:1,
        title:"Slim Fit Waffled jersey top",
        price:1499,
    ...
    {
        id: 4,
        title:"Loose Fit Denim shirt",
        price:2699,
        size:["XS" , "S" , "M" , 'L' , 'XL','XXL'],
        description: "Shirt in rigid cotton denim with a turn-down collar, classic front, patch chest pocket and a yoke at the back. Long sleeves with buttoned cuffs and a sleeve placket. Gently rounded hem. Loose fit for a generous but not oversized silhouette..",
        material:"Composition Cotton 90%, Polyester 9%, Elastane 1%",
        reviews: 2,
        ratings:5,
        color:"Denim blue",
